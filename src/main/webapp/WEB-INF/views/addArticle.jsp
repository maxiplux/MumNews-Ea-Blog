...
<html>
    <head>
        ...
        <style type="text/css">
            .section1 {color:#990000; text-align:center; float:left}
            .section2 {color:#990000; text-align:center; float:left}
            .section3 {color:#990000; text-align:center; float:left}
            .section4 {color:#990000; text-align:center; float:left}
            .section5 {color:#990000; text-align:center; float:left}
            .section6 {color:#990000; text-align:center; float:left}
        </style>
    </head>
<body>
...
autocomplete="off">
    ...
    <br>
        ...
        <tr>
            <td>Date:</td>
            <div id=".section1">
            <td><input name="publicationDate" id="date"/></td>
            </div>
        </tr>
        <br>
    ...
    <tr>
        ...
        <div> <td id=".section4"> <input type="file" name="file"/> </td></div>
